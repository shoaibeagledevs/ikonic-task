...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('affiliates', function (Blueprint $table) {
            ...
            //The float data type is not the most suitable choice for storing commission rates. Floats are approximate decimal values and can introduce rounding errors, which can be problematic when dealing with financial calculations. For precise and accurate representation of commission rates, it is recommended to use the decimal data type.
